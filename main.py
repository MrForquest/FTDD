...
from game_classes.Game_things import Thing, Weapon, Emperor, Potion
...
if __name__ == '__main__':
    ...
    weapon = Weapon((300, 400), player, 'Лук тёмного пламени', screen, 40,
                    25, 8, pygame.image.load('data/images/average_bow.png'),
                    pygame.image.load('data/images/dark_flame.png'), 40, 7)
    weapon2 = Weapon((350, 400), player, 'Посох Эндера', screen, 20,
                     25, 5, pygame.image.load('data/images/average_magic_stick.png'),
    ...
    all_sprites.add(Emperor((500, 400), player, 'Emperor', screen, 20, 25, 10,
