...
if __name__ == '__main__':
    ...
    all_sprites = pygame.sprite.Group(generate_level(group, screen, 15))
    ...
    # all_sprites.add(Emperor((500, 400), player, 'Emperor',
    # screen, 20,  pygame.image.load('data/images/average_bow.png')))
